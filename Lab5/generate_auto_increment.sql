...
begin
    drop_if_exists(table_name || '_pk_seq','SEQUENCE');
    EXECUTE IMMEDIATE 'CREATE SEQUENCE ' || table_name || '_pk_seq';
    
    auto_increment_script :=   'create or replace trigger ' || table_name ||
